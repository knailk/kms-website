                ...
                <Grid container sx={{ mb: '40px', mt: '20px', borderBottom: '1px solid rgb(93 93 93 / 50%)' }}>
                    ...
                    <Grid item xs={10} sx={{ pl: '25px', borderLeft: '1px solid rgb(93 93 93 / 50%)', pr: '20px' }}>
                        <Typography sx={{ mr: '20px', fontSize: '15px', fontWeight: '400' }}>
                            Các lớp học tại Smart KinderGarten được phân bổ theo từng độ tuổi, từ 1 tuổi đến 6 tuổi.
                            Phòng học được trang bị cơ sở vật chất, thiết bị đầy đủ, đa dạng phù hợp với độ tuổi của
                            từng lớp, nhằm đáp ứng nhu cầu trải nghiệm của trẻ cũng như mục tiêu giáo dục mà Smart
                            KinderGarten đưa ra.
                        </Typography>
                    </Grid>
                </Grid>
