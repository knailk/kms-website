            ...
            <Stack sx={{ maxWidth: '1200px' }}>
                ...
                <Accordion>
                    ...
                    >
                        ...
                        ngôn ngữ là vô cùng quan trọng, tại Smart KinderGarten chú trọng vào những trò chơi, bài học
                        thông qua những hình ảnh sinh động để trau dồi vốn từ cho trẻ, giúp cho trẻ phát triển ngôn ngữ
                        một cách mạch lạc.
                    </AccordionDetails>
                </Accordion>
                <Accordion>
                ...
                <Accordion>
                    ...
                    >
                        ...
                        ngôn ngữ thứ hai. Vì vậy, tại Smart KinderGarten đã cho trẻ sớm tiếp cận chương trình Tiếng Anh
                        với giáo viên bản ngữ để giúp trẻ có thể tiếp cận với ngôn ngữ thứ hai một cách hiệu quả.
                    </AccordionDetails>
                </Accordion>
                <Accordion>
                    <AccordionSummary
                ...
                <Accordion>
                    ...
                    >
                        ...
                        chữ để thỏa mãn nhu cầu muốn tự mình đọc được sách, truyện. Chương trình học tại Smart
                        KinderGarten sẽ giúp trẻ hoàn thiện các lĩnh vực phát triển, là nền tảng và hành trang để trẻ tự
                        tin bước vào cấp học mới.
                    </AccordionDetails>
                </Accordion>
            </Stack>
        </Stack>
